...
//			'accessControl', // perform access control for CRUD operations
	...
	{
		$dataProvider=new CActiveDataProvider('Yiilog', array('criteria'=>array('order'=>'id DESC')));
	...
	{
		$model=Yiilog::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='yiilog-form')
		{
